...
var Event = {  
    ...
    addEvent: function(Event, callback) {  
        return db.query("INSERT INTO events(event_title, event_description, event_approval, event_date, event_recurrence, event_price, event_voted, event_period, event_location id_user, id_user_Users) VALUES(?,?,?,?,?,?,?,?,?,?,?)", [Event.event_title, Event.event_description, Event.event_approval, Event.event_date, Event.event_recurrence, Event.event_price, Event.event_voted, Event.event_period, Event.event_location, Event.Id_user, Id_user_Users], callback);  
    },  
