...
var Users = {  
    ...
    updateUser: function(id, Users, callback) {  
        return db.query("UPDATE users SET User_firstname=?, User_lastname=?, User_mail=?, User_password=?, User_status=?, Id_center=? WHERE id_user=?", [Users.User_firstname, Users.User_lastname, Users.user_mail, Users.User_password, Users.User_status, Users.Id_center, id], callback); 
    }  
};  
