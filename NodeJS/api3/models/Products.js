...
var Products = {  
    getAllProducts: function(callback) {  
        return db.query("SELECT * FROM Products JOIN categories ON categories.Id_category = products.Id_category", callback);  
    },  
    getProductsById: function(id, callback) {  
        return db.query("SELECT * FROM Products JOIN categories ON categories.Id_category = products.Id_category WHERE Id_product=?", [id], callback);  
    },  
