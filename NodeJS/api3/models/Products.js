...
var Products = {  
    ...
    updateProduct: function(id, Products, callback) {  
        return db.query("UPDATE Products SET Product_name=?, Product_price=?, Product_description=?, Product_nbr_sold=?, Product_stock=?, Product_path_image=? WHERE Id_product=?", [Products.Product_name, Products.Product_price, Products.Product_description, Products.Product_nbr_sold, Products.Product_stock, Products.Product_path_image, Products.Id_category], callback); 
    }  
};  
