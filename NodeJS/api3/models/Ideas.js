...
var Ideas = {  
    getAllEvents: function(callback) {  
        return db.query("SELECT * FROM eventz JOIN users ON users.Id_users = eventz.Id_user WHERE eventz.Event_approval=0", callback);  // JOIN users ON users.Id_users = eventz.
    },  
