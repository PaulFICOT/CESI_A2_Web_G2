...
CREATE TABLE Users (
    ...
    CONSTRAINT Users_Centers_FK FOREIGN KEY (Id_center)
        REFERENCES Centers (Id_center)
)  ENGINE=INNODB;
...
CREATE TABLE Eventz (
    ...
    CONSTRAINT Eventz_PK PRIMARY KEY (Id_event),
    CONSTRAINT Eventz_Users_FK FOREIGN KEY (Id_user)
...
CREATE TABLE Photos (
    ...
    CONSTRAINT Photos_Eventz_FK FOREIGN KEY (Id_event)
        REFERENCES Eventz (Id_event)
)  ENGINE=INNODB;
...
CREATE TABLE Orders (
    ...
    CONSTRAINT Orders_Users_FK FOREIGN KEY (Id_user)
        REFERENCES Users (Id_user)
)  ENGINE=INNODB;
...
CREATE TABLE Products (
    ...
    CONSTRAINT Products_Category_FK FOREIGN KEY (Id_category)
...
CREATE TABLE Containz (
    Id_order INT NOT NULL,
    Id_product INT NOT NULL,
    CONSTRAINT Containz_PK PRIMARY KEY (Id_order , Id_product),
    CONSTRAINT Containz_Orders_FK FOREIGN KEY (Id_order)
        REFERENCES Orders (Id_order),
    CONSTRAINT Containz_Products0_FK FOREIGN KEY (Id_product)
...
CREATE TABLE Likes (
    ...
    CONSTRAINT Likes_Photos_FK FOREIGN KEY (Id_photo)
        REFERENCES Photos (Id_photo),
    CONSTRAINT Likes_Users0_FK FOREIGN KEY (Id_user)
        REFERENCES Users (Id_user)
)  ENGINE=INNODB;	
...
CREATE TABLE Signs_in(
        ...
        CONSTRAINT Signs_in_Eventz_FK FOREIGN KEY (Id_event) REFERENCES eventz(Id_event),
...
CREATE TABLE Votes (
    ...
    CONSTRAINT Votes_Eventz_FK FOREIGN KEY (Id_event)
        REFERENCES Eventz (Id_event),
    CONSTRAINT Votes_Photos_FK FOREIGN KEY (Id_user)
        REFERENCES Users (Id_user)
)  ENGINE=INNODB;