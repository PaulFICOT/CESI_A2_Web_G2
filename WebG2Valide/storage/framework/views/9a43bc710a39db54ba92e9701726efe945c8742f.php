            ...
            <div class="container">
                <div class="wrap">
                    <div class=" grid center">
                        ...
                        <h4 class="text-cesiBlue heavy-top">Clause n° 3 : Rabais et ristournes</h4>
                        <p class="small">Les tarifs proposés comprennent les rabais et ristournes que l’association BDE CESI ARRAS serait amenée à octroyer compte tenu de ses résultats ou de la prise en charge par l'acheteur de certaines prestations.</p>

                        <h4 class="text-cesiBlue heavy-top">Clause n° 4 : Escompte</h4>
                        <p class="small ">Aucun escompte ne sera consenti en cas de paiement anticipé.</p>

                        <h4 class="text-cesiBlue heavy-top">Clause n° 5 : Modalités de paiement</h4>
                        <p class="small">Le règlement des commandes s'effectue : </p>
                        <ul>
                            <li>
                                <p class="small">Soit par chèque ;</p>
                                <p class="small">Soit par espèce ;</p>
                                <p class="small">Soit par PayPal.</p>
                            </li>
                        </ul>
                        
                        <h4 class="text-cesiBlue heavy-top">Clause n° 6 : Retard de paiement</h4>
                        <p class="small">En cas de défaut de paiement total ou partiel des marchandises livrées au jour de la réception, l'acheteur doit verser à l’association BDE CESI ARRAS une pénalité de retard égale à trois fois le taux de l'intérêt légal.</p>
                        <p class="small">Le taux de l'intérêt légal retenu est celui en vigueur au jour de la livraison des marchandises.</p>
                        <p class="small heavy-top">Cette pénalité est calculée sur le montant TTC de la somme restant due, et court à compter de la date d'échéance du prix sans qu'aucune mise en demeure préalable ne soit nécessaire.</p>

                        <h4 class="text-cesiBlue heavy-top">Clause n° 7 : Livraison</h4>
                        <p class="small">La livraison est effectuée :</p>
                        <ul>
                            <li>
                                <p class="small">Soit par la remise directe de la marchandise à l'acheteur ;</p>
                                <p class="small">Soit au lieu indiqué par l'acheteur sur le bon de commande.</p>
                            </li>
                        </ul>
                        <p class="small">Le délai de livraison indiqué lors de l'enregistrement de la commande n'est donné qu'à titre indicatif et n'est aucunement garanti.</p>
                        <p class="small">Par voie de conséquence, tout retard raisonnable dans la livraison des produits ne pourra pas donner lieu au profit de l'acheteur à:</p>
                        <ul>
                            <li>
                                <p class="small">L’allocation de dommages et intérêts</p>
                                <p class="small">L’annulation de la commande.</p>
                            </li>
                        </ul>
