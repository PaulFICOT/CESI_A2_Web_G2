      ...
      <div class="container">
        <div class="wrap">
          <div class=" grid center">
              ...
              <p class="small">Mail : <a class="link" href="https://contact.ionos.fr/contact?linkId=ft.nav.support" target="_blank">https://contact.ionos.fr/contact?linkId=ft.nav.support</a></p>
              <p class="small">Site : <a class="link" href="https://www.ionos.fr" target="_blank">https://www.ionos.fr</a></p>
              ...
              Tel est le cas lorsque vous remplissez le formulaire qui vous est proposé en ligne, dans la rubrique</p><p class="small heavy-bottom text-cesiBlue bold">Connexion</p>
